...
public class JwtClaimTypes
{
    ...
    public static final String AuthenticationMethod = "amr";
    //
    // Summary:
    ...
    public static final String AuthenticationContextClassReference = "acr";
    //
    // Summary:
    ...
    public static final String AuthenticationTime = "auth_time";
    //
    // Summary:
    ...
    public static final String AccessTokenHash = "at_hash";
    //
    // Summary:
    ...
    public static final String AuthorizationCodeHash = "c_hash";
    //
    // Summary:
    ...
    public static final String ReferenceTokenId = "reference_token_id";
    //
    // Summary:
    ...
    public static final String PhoneNumberVerified = "phone_number_verified";
    //
    // Summary:
